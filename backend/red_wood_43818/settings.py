"""
Django settings for red_wood_43818 project.
...
ROOT_URLCONF = 'red_wood_43818.urls'
...
WSGI_APPLICATION = 'red_wood_43818.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "red_wood_43818 API",
    "DESCRIPTION": "API documentation for red_wood_43818 App",
    "VERSION": "v1",
}
